        ...
        <div class="row">
          <div class="col-md-4 mb-5">
            <div class="card wow fadeIn z-depth-1-half py-3">
              ...
              <img 
                  ...
                  src="img/svg/baseline-access_time-24px.svg" 
                  style="width: 25%;" alt="Icono tiempo">
          ...
          <div class="col-md-4 mb-5">
            ...
            <div class="card wow fadeIn z-depth-1-half py-3">
              ...
              <img 
                  class="card-img-top mx-auto" 
                  src="img/svg/baseline-notification_important-24px.svg" 
                  style="width: 25%;" 
          ...
          <div class="col-md-4">
            ...
            <div class="card wow fadeIn z-depth-1-half py-3">
              ...
              <img 
                  class="card-img-top mx-auto" 
                  src="img/svg/baseline-beenhere-24px.svg" 
                  style="width: 25%;" 
                  alt="Icono mapa">
      ...
      <div class="container">
        ...
        <div class="row d-flex flex-row align-items-center p-5">
          ...
          <div class="col-md-6 mb-5">
            ...
            <div 
                class="d-flex flex-row justify-content-start py-1 wow fadeInDown" 
                data-wow-delay="0.3s">
              <div>
