<?php
	...
	foreach ($rows as $key=>$value) {
		...
		if ($value['magnitud']>5.0 && isset($_GET['send'])=="1") {
			sendNotification($value['fecha_local'],$value['profundidad'],$value['magnitud'],$value['escala'],$value['sensible'],$value['referencia'],$value['imagen']);
		}
	}
