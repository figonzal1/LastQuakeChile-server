...
<body>
  ...
  <div class="container mt-5 pt-5 mb-5">
    ...
    <p>By downloading or using the app, these terms will automatically apply to you – you should make sure
      ...
      property rights related to it, still belong to Felipe González.</p>
    <p>Felipe González is committed to ensuring that the app is as useful and efficient as possible. For
    ...
    <p>The LastQuakeChile app stores and processes personal data that you have provided to us, in order to provide
      ...
      the LastQuakeChile app won’t work properly or at all. </p>
    <p>You should be aware that there are certain things that Felipe González will not take responsibility
    ...
    <p>Along the same lines, Felipe González cannot always take responsibility for the way you use
      the app i.e. You need to make sure that your device stays charged – if it runs out of battery and
      you can’t turn it on to avail the Service, Felipe González cannot accept responsibility.</p>
    <p>With respect to Felipe González’s responsibility for your use of the app, when you’re using
