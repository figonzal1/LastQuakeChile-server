...
<body>
    ...
    <div class="container mt-5 pt-5 mb-5">
        ...
        property rights related to it, still belong to Felipe González.</p> <p>Felipe González is committed to ensuring that the app is as useful and efficient as possible. For
        ...
        to you exactly what you’re paying for.</p> <p>The LastQuakeChile app stores and processes personal data that you have provided to us, in order to provide
        ...
        the LastQuakeChile app won’t work properly or at all. </p> <p>You should be aware that there are certain things that Felipe González will not take responsibility
            for. Certain functions of the app will require the app to have an active internet connection. The connection
            can be Wi-Fi, or provided by your mobile network provider, but Felipe González cannot take responsibility
        ...
        payer for using the app.</p> <p>Along the same lines, Felipe González cannot always take responsibility for the way you use
            the app i.e. You need to make sure that your device stays charged – if it runs out of battery and
        you can’t turn it on to avail the Service, Felipe González cannot accept responsibility.</p> <p>With respect to Felipe González’s responsibility for your use of the app, when you’re using
            ...
            it available to you. Felipe González accepts no liability for any loss, direct or indirect,
        you experience as a result of relying wholly on this functionality of the app.</p> <p>At some point, we may wish to update the app. The app is currently available on Android – the
            ...
            app. Felipe González does not promise that it will always update the app so that it is relevant
        ...
        <p>- felipe.gonzalezalarcon94@gmail.com</p>
    </div>
